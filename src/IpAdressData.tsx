...
function IPAddressData({ data }: IPData) {
  ...
  return (
    <div className="md:flex shadow-md w-[90%] [@media(min-width:500px)_and_(max-width:768px)]:w-[70%] max-w-4xl bg-white py-8 absolute rounded-xl items-center *:text-center bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 z-1000 space-y-4 md:space-y-0 ">
